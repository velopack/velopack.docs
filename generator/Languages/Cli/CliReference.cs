...
namespace DocGenerator.Languages.Cli;

/// <summary>
/// CLI reference generation (vpk + Setup.exe / Update.exe help capture). This is moved here
/// unchanged from the legacy CSharpReference.cs — it is out of scope of the unified-pipeline
/// rewrite and continues to run on the Windows/macOS/Linux matrix to capture native help.
/// </summary>
